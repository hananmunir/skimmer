          ...
          {Object.entries(options).map(([heading, items], index) => (
            <div key={index}>
              ...
              {heading.includes("(single select)") ? (
                  <Select
                  value={singleSelectGroups[heading]?.name || ""}
                  onChange={(e) => handleSingleSelectChange(heading, e.target.value)}
                ...
                >
                  ...
                  {items.map((item, idx) => (
                    <MenuItem key={idx} value={item} sx={{
                      fontSize: 12,
                    }}>
                  ...
                  {items.map((item, idx) => (
                    <div key={idx} className="menu-item">
                      <input
                        ...
                        onChange={(e) => handleMultiSelectChange(item, e.target.checked)}
                      />
                      ...
                      {item.name === "6’ Power pole - $1,950" && (
                        <div className="quantity-input">
                          ...
                          <input
                            ...
                            min="0"
                            max="2"
                            value={selectedOptions.filter((option) => option.name === item.name).length}
                            onChange={(e) =>
